# Oma Edge 0.1.3 release preparation
...
## 0.1.3 patch validation

- Full Python, Node, and Lua checks pass, including window-title labels and empty-title fallback.
- Existing saved labels require removing and re-adding the app. Class-based matching is unchanged.
- Live desktop checks below describe earlier preview validation, not a new 0.1.3 desktop run.
...
2. Create/push the public repository and run its CI. Tag the tested commit `v0.1.3`
